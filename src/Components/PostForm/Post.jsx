    ...
    return ( 
        <form onSubmit={handleSubmit}>
            ...
            <div className='form-group row'>
                ...
                <div className='col-sm-10'>
                    <input type='text' rows="2" className="form-control" id="colFormLabel" value={post} onChange={(event) => setPost(event.target.value)} />
                </div>
            </div>
            <div className='col-auto'>
                <button type='submit' className="btn btn-primary mb-2" style={{'margin-top': '1em'}} >Create</button>
            </div>
        </form>
